...
@section('breadcrumb')
<h4 class="page-title">Edit Aset</h4>
<div class="ml-auto">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-4">Form Edit Aset/Inventaris</h5>

                <form action="{{ route('backend.aset.update', $aset->id) }}" method="POST" enctype="multipart/form-data" hx-boost="false">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                          ...
                                          name="deskripsi"
                                          rows="4"
                                          placeholder="Masukkan deskripsi lengkap aset">{{ old('deskripsi', $aset->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kategori') is-invalid @enderror"
                                    ...
                                    <option value="Alat Medis" {{ old('kategori', $aset->kategori) == 'Alat Medis' ? 'selected' : '' }}>Alat Medis</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       id="supplier"
                                       name="supplier"
                                       value="{{ old('supplier', $aset->supplier) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="nilai_saat_ini"
                                           name="nilai_saat_ini"
                                           value="{{ old('nilai_saat_ini', $aset->nilai_saat_ini) }}"
                                           placeholder="8000000"
                                           step="0.01"
                                           required>
                                ...
                                <small class="form-text text-muted">Nilai aset setelah depresiasi</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('status_aset') is-invalid @enderror"
                                    ...
                                    <option value="rusak" {{ old('status_aset', $aset->status_aset) == 'rusak' ? 'selected' : '' }}>Rusak</option>
                                    <option value="hilang" {{ old('status_aset', $aset->status_aset) == 'hilang' ? 'selected' : '' }}>Hilang</option>
                                    <option value="dijual" {{ old('status_aset', $aset->status_aset) == 'dijual' ? 'selected' : '' }}>Dijual</option>
                                </select>
                                @error('status_aset')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="date"
                                       ...
                                       value="{{ old('last_maintenance', $aset->last_maintenance) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date"
                                       ...
                                       value="{{ old('next_maintenance', $aset->next_maintenance) }}">
